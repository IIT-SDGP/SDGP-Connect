        ...
        headers: [
          {
            ...
            value: "default-src 'self'; img-src 'self' data: https:; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://fonts.googleapis.com http://localhost:3001; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com http://localhost:3001; font-src 'self' https://fonts.gstatic.com; connect-src 'self' http://localhost:3001 ws://localhost:3001; frame-src 'self' https://www.youtube.com https://player.vimeo.com https://vimeo.com http://localhost:3001; worker-src 'self' blob:; frame-ancestors 'none';"
          },
          {
            key: 'Referrer-Policy',
